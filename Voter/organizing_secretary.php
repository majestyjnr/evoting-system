...
if(isset($_POST['daniel_essel'])){

    $organizing_secretary = $_POST['daniel_essel'];
    $organizing_secretary = 'Daniel Essel';
    
    $_SESSION['organizing_secretary_aspirantname'] = $organizing_secretary;
 ...
 }elseif(isset($_POST['majesty_aidoo'])){
 
    $organizing_secretary = $_POST['majesty_aidoo'];
    $organizing_secretary = 'Majesty Aidoo';
 ...
 }elseif(isset($_POST['appiah_nti'])){
 
   $organizing_secretary = $_POST['appiah_nti'];
   $organizing_secretary = 'Appiah Nti';
  ...
  $_SESSION['organizing_secretary_aspirantname'] = $organizing_secretary;
   ...
   header("location:pro.php");
    ...
    $organizing_secretary = $_POST['skip'];
    $organizing_secretary = 'Skipped';
...
?>
    ...
    <div class="container" style="padding:70px;">
      <center> <h2>Organizing Secretary</h2> </center>
      <center>
      <div class="col-sm-12" style="border:2px solid #0099ff; padding: 20px">
        <div class ="floating-box">
          <img src="../pictures/cto.jpg" class="img img-thumbnail" style="width:200px;" alt="">
            <h4 class="normalFont text-center"><?php echo 'Daniel Essel'?></h4>
            <hr>

          <form action="organizing_secretary.php" method ="POST">
              <button type="submit" class="btn btn-block span btn-primary" name="daniel_essel" style="width:150px; "><span class="glyphicon glyphicon-user"></span> Vote</button>
          </form>
        </div>
        ...
        <div class ="floating-box">
          ...
          <h4 class="normalFont text-center"><?php echo 'Majesty Aidoo'?></h4>

            <hr>
          
            <form  action="organizing_secretary.php" method ="POST">
                <button type="submit" class="btn btn-block span btn-primary " name="majesty_aidoo" style="width:150px; "><span class="glyphicon glyphicon-user"></span> Vote</button>
            </form>
        </div>


        <div class ="floating-box">
          <img src="../pictures/pro.jpg" class="img img-thumbnail" style="width:200px;" alt="">
          <h4 class="normalFont text-center"><?php echo 'Appiah Nti'?></h4>
        <hr>

        <form  action="organizing_secretary.php" method ="POST">
          <button type="submit" class="btn btn-block span btn-primary " name="appiah_nti" style="width:150px; "><span class="glyphicon glyphicon-user"></span> Vote</button>
        </form>
