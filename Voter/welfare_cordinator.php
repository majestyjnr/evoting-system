...
<html lang="en">
  ...
  <body>
    ...
    if(isset($_POST['samuel_brown'])){
    
        $welfare_cordinator = $_POST['samuel_brown'];
        $welfare_cordinator = 'Samuel Brown';
        
        $_SESSION['welfare_cordinator_aspirantname'] = $welfare_cordinator;
        
        @$welfare_cordinator = $_SESSION['welfare_cordinator_aspirantname'];
      
      
          header("location:votesuccessful.php");
     
     
     }elseif(isset($_POST['winfred_quaye'])){
     
        $welfare_cordinator = $_POST['winfred_quaye'];
        $welfare_cordinator = 'Winfred Quaye';
     ...
     }elseif(isset($_POST['boandwoh_kwasi'])){
     
       $welfare_cordinator = $_POST['boandwoh_kwasi'];
       $welfare_cordinator = 'Boandwoh Kwasi';
      ...
      $_SESSION['welfare_cordinator_aspirantname'] = $welfare_cordinator;
       ...
       header("location:votesuccessful.php");
        ...
        $welfare_cordinator = $_POST['skip'];
        $welfare_cordinator = 'Skipped';
...
?>
    ...
    <div class="container" style="padding:70px; ">
      <center> <h2>Welfare Cordinator</h2> </center>
      ...
      <div class="col-sm-12" style="border:2px solid #0099ff; padding: 20px">
        <div class ="floating-box">
          <img src="../pictures/hrm.jpg" class="img img-thumbnail" style="width:200px;" alt="">
            <h4 class="normalFont text-center"><?php echo 'Samuel Brown'?></h4>
            <hr>

          <form action="welfare_cordinator.php" method ="POST">
              <button type="submit" class="btn btn-block span btn-primary " name ="samuel_brown" style="width:150px; "><span class="glyphicon glyphicon-user"></span> Vote</button>
          </form>
        </div>
        ...
        <div class ="floating-box">
            <img src="../pictures/acc.jpg" class="img img-thumbnail" style="width:200px;" alt="">
             <h4 class="normalFont text-center"><?php echo 'Boandwoh Kwasi'?></h4>
            <hr>

            <form  action="welfare_cordinator.php" method ="POST">
              <button type="submit" class="btn btn-block span btn-primary "  name ="boandwoh_kwasi" style="width:150px; "><span class="glyphicon glyphicon-user"></span> Vote</button>
            </form>
