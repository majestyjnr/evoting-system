    ...
    " role="navigation">
      <div class="container">
        ...
        <div id= "autoload" style="padding-top:20px;  " class="">
            ...
            <center><h2 class="specialHead"><b>Treasurer</b></h2></center>
          </div>
          ...
          <div class="col-sm-12">
            <?php
              ...
              if(mysqli_num_rows($result)>0)
              {
                ...
                //BJP
                $sql ="SELECT * FROM voters WHERE Treasurer = 'Agyei Badu' ";
                $result= mysqli_query($link, $sql);
                ...
                if($query_num_rows > 0)
                {
                  ...
                  $percentage = $AB/$total*100;
                  $approximated_percentage = substr($percentage, 0, 5);
                  $ab_value= $approximated_percentage;

                  echo "<strong><span style='font-size: 20px;'>Agyei Badu</span>       <span style='float: right; font-size: 27px'>$approximated_percentage %<span></strong><br>";
                  echo "<span style ='font-size: 20px'>$AB Votes</span>  
                  <div class='progress'>
                    <div class='progress-bar progress-bar-success' role='progressbar' aria-valuenow=\"70\" aria-valuemin=\"0\" aria-valuemax=\"100\" style='width: ".$ab_value."%'>
                ...
                // CONGRESS
                $sql ="SELECT * FROM voters WHERE Treasurer = 'Akwasi Baako' ";
                $result= mysqli_query($link, $sql);
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  $percentage = $KB/$total*100;
                  $approximated_percentage = substr($percentage, 0, 5);
                  $kb_value= $approximated_percentage;

                  echo "<strong><span style='font-size: 20px;'>  Akwasi Baako  </span>   <span style='float: right; font-size: 27px'>$approximated_percentage %<span></strong><br>";
                  echo "<span style ='font-size: 20px'>$KB Votes</span>  
                  <div class='progress'>
                    <div class='progress-bar progress-bar-primary' role='progressbar' aria-valuenow=\"70\" aria-valuemin=\"0\" aria-valuemax=\"100\" style='width: ".$kb_value."%'>
                ...
                // Ruth Aidoo
                $sql ="SELECT * FROM voters WHERE Treasurer = 'Dr Aidoo' ";
                $result= mysqli_query($link, $sql);
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  <div class='progress'>
                    <div class='progress-bar progress-bar-info' role='progressbar' aria-valuenow=\"70\" aria-valuemin=\"0\" aria-valuemax=\"100\" style='width: ".$da_value."%'>
                  ...
                  ";
                         ...
                         // Skipped
                         $sql ="SELECT * FROM voters WHERE Treasurer = 'Skipped' ";
                         $result= mysqli_query($link, $sql);
...
$(document).ready(function(){
    $('#autoload').load('results_treasurer.php') 
    refresh();
});

function refresh(){
    setTimeout( function(){
        $('#autoload').fadeOut('slow').load('results_treasurer.php').fadeIn('slow');
        refresh();
    }, 3000); 
}
</script>
