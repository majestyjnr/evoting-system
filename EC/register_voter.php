...
<body>
    ...
    " role="navigation">
        	...
        	-->
                    ...
                    <span class="normalFont"><a href="dashboard.php" class="btn btn-info navbar-right navbar-btn"
                            style="float: right"><strong> Back </strong></a></span>
                </div>
                ...
                <div class="col-sm-4" style="border:2px solid #0099ff;padding:30px;">
                    ...
                    <div class="page-header">
                        <center><img src="../images/user.png" style="width:70px">
                            <h2 class="specialHead">Verification Form</h2>
                        </center>
                    </div>
                    ...
                    <form action="register.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" name="idnumber" class="form-control" placeholder="Enter Index Number"
                                autocomplete="off" required><br>


                            <button type="submit" class="btn btn-block span btn-primary "><span
                                    class="glyphicon glyphicon-user"></span> Verify Voter</button>
