...
<html lang="en">
  ...
  <body>
  <audio src ="enterauthorizationcode.mp3" id ="my_audio"  autoplay ="autoplay"></audio>
    ...
    <div class="container" style="padding-top:100px;">
    	<div class="row">
          ...
          <center><img src="../images/user.png" style="width:70px">
    				<h2 class="specialHead">EC Authentication Form</h2>
          </center>
          </div>
          
          <form action="ec_auth.php" method="POST">
      			<div class="form-group">
      				<label for="">Electoral Commissioner Name</label><br>
      				<input type="text" name="ecname" placeholder="Enter Your Name" class="form-control" autocomplete="off" required><br>
