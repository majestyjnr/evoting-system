        ...
        <center>
    		<div class="col-sm-4" style="border:2px solid #0099ff;padding:30px;">
              ...
              if(isset($_POST['ecname']) && isset($_POST['password'])){
                ...
                // $query = "INSERT INTO tbl_admin (admin_username,admin_password) VALUES ('$indexnumber' , '$studentname')";
                $query = "SELECT * From tbl_admin where `admin_username` = '$ecname' AND `admin_password` ='$password' ";
                ...
                $query_num_rows = mysqli_num_rows($query_run);
                  ...
                  if($query_num_rows>=1){
                    ...
                    while($query_row = mysqli_fetch_assoc($query_run)){
                      ...
                      $ec_name = $query_row['admin_username'];
                      $_SESSION['admin_username'] = $ec_name;
                  ...
                  echo "<p class='normalFont text-primary' ><strong>Enter Valid Credentials</strong> </p><br>";
                  echo "<p class='normalFont text-primary'><strong>Please try again!</strong> </p>";
                  echo "<br><a href='index.php' class='btn btn-primary'><span class='glyphicon glyphicon-refresh'></span> <strong>Try Again</strong></a>";
